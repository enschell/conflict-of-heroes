...
console.log(`Conflict of Heroes — 2000-game self-play analysis (AtB Firefight 9 - KV2, v3 rules)`);
console.log(`Scheduled 2000 games (200 random-vs-random control + 1800 across the 5x5 heuristic grid)...\n`);

for (let k = 0; k < 200; k++) results.push({ ...playGame(seedCounter++, 'random', 'random'), block: 'control' });
...
console.log(
  `  random       : (control only, ${results.filter((r) => r.block === 'control' && r.winner === 'A').length}/200 as A) | ` +
